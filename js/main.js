...
function startBenchmark(mode) {
  ...
  benchmark = { mode, target: randomTarget(), startTime: performance.now(), matched: false };
...
downloadLogBtn.addEventListener("click", () => {
  ...
  const header =
    "timestamp_ms,fps,hands_detected,state,pan_dx,pan_dy,rotate_dx,rotate_dy,zoom,pinch_dist,action\n";
...
// --- Gesture action handling (fist = reset, thumbs up/down = wireframe) ---
